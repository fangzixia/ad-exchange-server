...
func (b *PlatformXAdapter) MarshalRequest(internalReq *model.AdPlatformContent) ([]byte, error) {
...
func (b *PlatformXAdapter) UnmarshalResponse(c *model.AdPlatformContent, respBytes []byte) (*model.AdInternalResponse, error) {
